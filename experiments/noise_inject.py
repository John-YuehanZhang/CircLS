"""ONE shared noise pass for the tqec comparison (A1(1)) — applied to BOTH
sides' noiseless circuits, so neither compiler's built-in noise model
participates and "different noise semantics" is off the table.
